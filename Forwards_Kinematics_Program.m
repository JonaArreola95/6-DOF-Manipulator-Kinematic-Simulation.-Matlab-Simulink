%% FORWARD KINEMATICS AND TRANSFORMATION MATRIX VERIFICATION FOR THE JonaBot
% This program calculates the transformation matrixes for the JonaBot, then it
% evaluates them using a set of angles to obtain the T06 and the T0tcp Frames.
